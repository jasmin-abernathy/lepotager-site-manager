...
class IosManagerController(
    ...
    init {
        ...
        scope.launch { holder.initialize() }
    }
    ...
    override fun uploadMedia(
        ...
        // Le picker iOS reste désactivé tant que PhotoKit n’est pas branché.
        // Cette méthode ne peut donc pas être atteinte depuis l’UI dans ce lot.
    }
